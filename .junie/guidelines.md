# Guidelines — vetify-squad-knowledge

> ⚠️ Formato no verificado en este proyecto todavía — si tu plugin de IA en IntelliJ no lo lee
> solo, pasale el contenido de `README.md` y `AGENTS.md` a mano al arrancar.
...
- `.claude/skills/` son ayudas que se auto-cargan solo en Claude Code — acá podés igual leer su
  contenido como referencia de proceso, aunque no se activen solas.
